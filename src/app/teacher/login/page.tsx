...
export default async function TeacherLoginPage({
  ...
  return (
    <section className="mx-auto max-w-md space-y-6 rounded-lg border border-zinc-200 bg-white p-6">
      <div className="space-y-2">
        <h1 className="text-2xl font-semibold">Teacher login</h1>
        <p className="text-sm text-zinc-600">Sign in to manage your classes.</p>
      </div>
      {error ? (
